...
<title>Smeg Libya | Classic</title>
    ...
    <div class="aesHeader padding">
      <div class="row">
        <div class="col-md-5">
          ...
          <a href="searchResults.php?keyword=كلاسيكا" class="prodLink">مشاهدة المنتجات</a>
          <!-- scroll animation -->
          <div class="center">
...
<div class="container descContainerBS">
    <div class="row" >
        <div class="col-md-8 descContainer">Classica هو الاسم الذي يطلق على الخط الجمالي الأول الذي طوره Smeg بالاشتراك مع المهندس المعماري Guido Canali. النطاق مميز للطريقة التي يستخدم بها الفولاذ المقاوم للصدأ بأقصى درجات الدقة الأسلوبية. كلاسيكا ، الذي يشمل الأفران والمواقد وآلات القهوة والثلاجات والشفاطات ، يسلط الضوء على مقابض التحكم الفريدة ومقابض الأفران ، التي تتحد أشكالها النظيفة والمكررة والحديثة لخلق عناصر التصميم الصناعي.

            بالإضافة إلى الجماليات الأنيقة التي تعكس قيم علامة Smeg التجارية ، تتميز هذه المنتجات بمستوى من الوظائف والأداء يجعلها من بين أكثر المنتجات تنوعًا في السوق.  </div>
        <div class="col-md-4 descContaineralign">
          <h4>مجموعة كلاسيكا من كانالي ستوديو
