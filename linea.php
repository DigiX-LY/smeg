...
<!--Page Header-->
<section class="header_layout2 padding lineaBG inverter">
  <div class="container">
    ...
    <div class="aesHeader padding">
      <div class="row">
        <div class="col-md-5 inverter">
          ...
          <a href="searchResults.php?keyword=لينيا" class="prodLink">مشاهدة المنتجات</a>
          <!-- scroll animation -->
          <div class="center">
            ...
            <div class="scrollCont" style="height: 60px;overflow: hidden;width: 40px;">
              <div class="scroll" style="background-color: rgb(53, 53, 53);">
              </div>
            </div>
          </div>
          <!-- scroll anim end -->
