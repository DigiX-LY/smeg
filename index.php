...
<body>
    ...
    <section id="grid_box">
        <div class="container-fluid blacksection">
            <!--M.yousef changed container to container-fluid to get a fitscreen-->
            <div class="row">
                <div class="col-md-6">
        ...
        <div class="container videoContParent fridgeDemoHover">
            <div class="row">
                ...
                <div class="col-md-4 fridgeDesc">
                    ...
                    <h6 class="videoDesc">
                        أسلوب Smeg هو الطريقة التي يتواصل بها المنتج مع محيطه ويمكّن المستخدمين من التفاعل معه، وبالتالي
                        إقامة علاقة مع المستخدم تتجاوز مجرد الاهتمامات العملية.
                ...
                <div class="col-md-6">
                    <div data-aos="fade-right" data-aos-duration="2000">
                        <div class="design_img img-hover-zoom">
                            <img src="images/services.jpg" alt="desing Product" width="100%">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="descrp">
                        <div data-aos="fade-left" data-aos-duration="2000"><span class="subheader"> خدماتنا </span>
                            <p>خدمات الصيانة مع الضمانة
                                الصيانة الفورية لجميع منتجات سميج مع نخبة مختارة من الفنيين المتخصصين المدربين على
                                الصيانة مع الخدمة المميزة التي تهدف لارضاء زبائننا، للإبلاغ عن أي أعطال إتصلوا بالقسم
                                التقني.
                                <br><br><br>
                                Tel: 0918884889
                                <br>

                                support@almotamaiza.ly
                            </p>
    ...
    <section loading="lazy" dir="rtl" id="contact" class="tm-bg-color-5 tm-mb-3 ">
        ...
        <div class="tm-bg-color-white tm-contact-main contactUS">
            ...
            <div class="contactBorder">
                ...
                <div class="cityTabs">
                    <button class="cityButton active" onclick="openCity(event, 'Tripoli')" id="defaultOpen">
                        طرابلس</button>
                    ...
                    <div class="flexContents">
                        <div class="contactInfo">
                            <div class="numbers">
                                <div class="contactLabel">
                                    <img loading="lazy" src="logo/call.png" class="contactIcon" width="24px"
                                        height="24px" alt="">
                                    <h2>الأرقام</h2>
                                </div>
                            ...
                            <div class="emails">
                                <div class="contactLabel">
                                    <img loading="lazy" src="logo/email.png" class="contactIcon" width="24px"
                                        height="24px" alt="">
                                    <h2>البريد الالكتروني</h2>
                                </div>
                                <div class="borderRight">
                                    <ul>
                                        <li>info@almotamaiza.ly</li>
                                        <li>sales@almotamaiza.ly</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="location">
                                <div class="contactLabel">
                                    <img loading="lazy" src="logo/pin.png" class="contactIcon" width="24px"
                                        height="24px" alt="">
                                    <h2>وصف الموقع</h2>
                                </div>
                                <div class="borderRight">
                        ...
                        <div class="map-outer ">
                            <div class="gmap-canvas">
                                <iframe loading="lazy" id="gmap-canvas" class="tripMap" src="" frameborder="0"
                ...
                <div id="Misrata" class="tabContent" style="color: white;">
                    <div class="flexContents">
                        ...
                        <div class="map-outer ">
                            <div class="gmap-canvas">
                                <iframe loading="lazy" id="gmap-canvas" class="misuMap" src="" frameborder="0"
                                    scrolling="no" marginheight="0" marginwidth="0">
                                </iframe>
                            </div>
                        </div>
            ...
            <div loading="lazy" class="contactFormFlex">
                ...
                <div class="contactContentFlex">
                    <div class="descrp">
                        نحن دائما على استعداد لتزويدك بأعلى مستوى من الدعم. العلاقة بيننا وبين كل عميل مهمة للغاية
                        بالنسبة لنا، لذلك يمكنك ملئ النموذج الخاص بالتواصل وسوف نقوم بالاتصال بك في أقرب وقت.
                        <div class="sendMessage">
                            <img loading="lazy" src="logo/send-message.png" alt="">
                        </div>
                    </div>
                    <div class="contact-form-outer">
                        <form id="contact-form" class="tm-bg-color-6 tm-contact-form contactForm">
                            ...
                            <div class="form-group">
                                <input type="email" name="email" id="email" class="form-control"
                                    placeholder="بريد الإلكتروني" required="" />
                            </div>
                            <div class="form-group">
                            ...
                            <div style="text-align: center;">
                                <button onclick="sendMAIL()" type="button" id="SendEmail" name="SendEmail"
                                    class="ml-auto tm-btn tm-btn-3">
                                    إرسال
                                </button>
                            </div>
                        </form>
    ...
    <script>
        ...
        function sendMAIL(event) {
            ...
            $.post('https://w8ggkb4xv7.execute-api.eu-central-1.amazonaws.com/contact-form/smeg', JSON.stringify(email), function () {
                console.log('success');
            })
