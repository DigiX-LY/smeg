...
<section class="header_layout2 padding aboutBG">
  <div class="container">
    ...
    <div class="aesHeader padding aboutPage">
      <div class="row">
        <div class="col-md-5">
          <h1 id="textAppear">نطمــح إلى تحسيـــن نــمط حياة الأفراد </h1>
          <h3 id="textAppearSub" style="text-align:justify;">
          
          شركة المتميزة الدولية لإستيراد الأجهزة الكهربائية هي شركة ليبية رائدة في مجال إستيراد الأجهزة الكهرومنزلية بكافة أنواعها ، تساهم شركة المتميزة الدولية لإستيراد الأجهزة الكهربائية منذ تأسيسها عام 2000 في تغطية متطلبات السوق الليبي وتحرص على تزويده بمختلف الأصناف المطابقة لمواصفات ومعايير الجودة العالمية مع المحافظة على الأسعار المناسبة لكسب رضى العملاء والمستهلكين.
...
<div class="container" dir="rtl">
  ...
  <li class="media col-lg-4" >
    ...
    <div class="media-body">
      ...
      إستجابة لأذواق المستهلكين والمنافسة المتزايدة في السوق الليبي تلتزم شركة المتميزة الدولية لإستيراد الأجهزة الكهربائية بالمحافظة على أعلى المعايير مع توظيف أفضل المواهب في هذا المجال مع الحرص على الالتزام باستيراد وتوزيع منتجات ذات جودة عالية.    
...
<div class="container videoContParent fridgeDemoHover">
  <div class="row" >
      ...
      <div class="col-md-5">
       ...
       <br><br> 
       - شغف التقدم: لا يرتبط عمل شركة المتميزة الدولية لإستيراد الأجهزة الكهربائية بتقديم منتجات كهرومنزلية فحسب بل هو أيضاً عبارة عن إبتكار أفكار والفوز بالسوق وخدمات متجددة.
...
<!-- ------------=========CONTENTS HERE=========------------ -->
<!-- place holders -->
<img src="images/product-box2.png" alt=""><br>
<img src="images/product-box2.png" alt=""><br>
<img src="images/product-box2.png" alt=""><br>
<!-- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ -->
