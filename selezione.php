...
<title>Smeg Libya | Selezione </title>
    ...
    <div class="aesHeader padding">
      <div class="row">
        <div class="col-md-5">
          ...
          <a href="searchResults.php?keyword=اختياري" class="prodLink">مشاهدة المنتجات</a>
          <!-- scroll animation -->
          <div class="center">
...
<section class="PageNav">
    <div class="flexHeader">
        ...
        <p class="firstPara">
        يجمع الفولاذ المقاوم للصدأ بين الشكل المريح
        </p>
    </div>
    <div class="flexPictureHead">
        <img src="images/aeslines/selez/selez.jpg">
    </div>
    
<div class="container descContainerBS">
    <div class="row" >
        <div class="col-md-8 descContainer">
        أسلوب اختياري هو طراز بسيط وعملي، حيث يشتمل على مقابض وزوايا تحكم في خطوط تصميمه الأنيقة. توفر هذه المجموعة المتواضعة من الأفران وأفران الميكروويف والمواقد الانسجام والتوازن في تصميم المطبخ الحديث ، حيث تجمع بين الأناقة والموثوقية.
        </div>
