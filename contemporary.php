    ...
    <div class="aesHeader padding">
      <div class="row">
        <div class="col-md-5">
          ...
          <h1>معاصر</h1>
          <h3>
          الوظيفة الأنيقة للخطوط الناعمة والحواف المستديرة.
          </h3>
          <a href="searchResults.php?keyword=معاصر" class="prodLink">مشاهدة المنتجات</a>
          <!-- scroll animation -->
          <div class="center">
...
<section class="PageNav">
    <div class="flexHeader">
        ...
        <p class="firstPara">
        تتناغم الخطوط الناعمة والحواف الدائرية للخط المعاصر بشكل مثالي مع الاحتياجات الوظيفية والمريحة والعملية وتمكن الأجهزة من التوافق بسلاسة مع الإعدادات الداخلية المختلفة.
        </p>
    </div>
...
<div class="container descContainerBS">
    <div class="row" >
        ...
        تعتبر الأفران الكهربائية والمواقد في المجموعة من أحدث المنتجات التي تكشف مرة أخرى سر التصميم الإيطالي: مزيج من العبقرية الإبداعية ومهارات التصنيع وقاعدة العملاء التي تمنح المصممين الإيطاليين الحرية لإعادة تفسير ما يجعل شيئًا جميلًا باستمرار.
        </div>
